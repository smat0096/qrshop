...
class SearchView
{
     ...
     * @return    string
     */
    function GetArcList($limitstart=0,$row=10,$col=1,$titlelen=100,$infolen=250,
    ...
    function GetPageListDM($list_len)
    {
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<li width='50'><a href='".$purl."PageNo=$prepagenum'>上一页</a></li>\r\n";
            $indexpage="<li width='30'><a href='".$purl."PageNo=1'>首页</a></li>\r\n";
        }
        else
        {
            $indexpage="<li width='30'>首页</li>\r\n";
        }
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<li width='50'><a href='".$purl."PageNo=$nextpagenum'>下一页</a></li>\r\n";
            $endpage="<li width='30'><a href='".$purl."PageNo=$totalpage'>末页</a></li>\r\n";
        }
        else
        {
            $endpage="<li width='30'>末页</li>\r\n";
        }
        ...
        {
            $plist.="<td width='38'><input type='text' name='PageNo' style='width:28px;height:14px' value='".$this->PageNo."' /></li>\r\n";
            $plist.="<td width='30'><input type='submit' name='plistgo' value='GO' style='width:30px;height:22px;font-size:9pt' /></li>\r\n";
        }
        return $plist;
    }
